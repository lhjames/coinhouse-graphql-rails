# This seed was used for development purposes and is now partially obsolete. Please use the Rails console (rails + c) or the GraphQl Query if you need to create users or events.
